...
4) Arrays 🦖 :- it contains basic implementation of 1D array and 2D array questions and it's solution's,kadans algorithm. 1D array is also linked to the arrays folder in 1D Arrays there are some basic questions that are linked to the basic as well as to little bit advance problems od array basic use.
